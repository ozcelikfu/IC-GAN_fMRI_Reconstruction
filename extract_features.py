...
class batch_generator_external_images(Dataset):
    ...
    """
    def __init__(self, data_path = './KamitaniData/images_256.npz', mode='test_images'):
...
image_path = './KamitaniData/images_256.npz'
batch_size = 5
...
np.savez('extracted_features/instance_features.npz', train_instance=train_instance, test_instance=test_instance)